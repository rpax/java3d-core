...
class VersionInfo extends Object {
     ...
     */
    private static final String VENDOR_DEVELOPER = "RafaelPax";
     ...
     */
    static final boolean isDebug = false;//@IS_DEBUG@;
     ...
     */
    static final boolean isDevPhase = false;//@IS_DEV_PHASE@;
     ...
     */
    static final boolean isProduction = true;//@IS_PRODUCTION@;
     ...
     * default value is true.
     */
    private static final boolean useVerboseBuildTime = false;//@USE_VERBOSE_BUILDTIME@;
     ...
     * is "daily".
     */
    private static final String BUILD_TYPE = "stable";
     ...
     */
    private static final String VERSION_BUILD = "build01";
